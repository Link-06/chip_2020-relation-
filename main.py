...
train_data = load_data('./chip_2020_2_train/train_data.json')
valid_data = load_data('./chip_2020_2_train/val_data.json')

# 读取schema
with open('./chip_2020_2_train/53_schemas_1.json') as f:
...
if __name__ == '__main__':
    ...
    predict_to_file('./chip_2020_2_train/test1.json', 'ie_pred_150e.json')
